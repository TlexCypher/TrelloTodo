...
const ModalForm = () => {
  const [taskType, setTaskType] = useModalStore((state) => [
    state.taskType,
    state.setTaskType,
  ])
  ...
  return (
    <div className='max-w-md mx-auto w-full bg-white px-20 py-10 text-center rounded-xl'>
      ...
      <button className='bg-pink-300/60 text-pink-600/80 italic font-bold p-2 rounded-lg 
