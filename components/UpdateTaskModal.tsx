...
import UpdateTaskModalForm from "@/components/UpdateTaskModalForm";
...
const UpdateTaskModal = () => {
    const [isOpen, openModal, closeModal] = useUpdateTaskModalStore((state) => [state.isOpen, state.openModal, state.closeModal])
    return (
